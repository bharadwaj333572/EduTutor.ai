            ...
            <Card className="cursor-pointer transition-all duration-300 hover:shadow-lg hover:scale-105 border-2 hover:border-blue-300">
              ...
              <CardContent>
                <Button className="w-full" size="lg" asChild>
                  <Link to="/student-dashboard">Start Learning</Link>
                </Button>
              </CardContent>
            </Card>

            <Card className="cursor-pointer transition-all duration-300 hover:shadow-lg hover:scale-105 border-2 hover:border-purple-300">
              <CardHeader className="text-center">
              ...
              <CardContent>
                <Button className="w-full" size="lg" variant="secondary" asChild>
                  <Link to="/educator-dashboard">View Analytics</Link>
                </Button>
              </CardContent>
            </Card>
          </div>
